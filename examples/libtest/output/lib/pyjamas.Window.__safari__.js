...
$pyjs.loaded_modules['pyjamas.Window'] = function (__mod_name__) {
	...
	try {
		...
		$m['setOnError'] = function(onError) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $bool10,$bool12,$bool9,$bool11;
			if ((($bool12=!(($bool11=$p['callable'](onError)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
				false :
    ...
    $wnd.onerror=function(msg, url, linenumber){
		...
		$m['fireClosingImpl'] = function() {
			if ($pyjs.options.arg_count && arguments.length != 0) $pyjs__exception_func_param(arguments.callee.__name__, 0, 0, arguments.length);
			var $iter2_nextval,$iter2_type,$iter2_iter,$bool13,ret,listener,$iter2_idx,$pyjs__trackstack_size_1,msg,$iter2_array;
			...
			while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
				...
				$pyjs.track.lineno=41;
				if ((($bool13=$p['op_is'](ret, null)) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
						false :
