...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
    ...
    while (cur && (cur.nodeType == 1)) {
		...
		$m['mash_name_for_glib'] = function(name, joiner) {
			...
			var c,$iter1_nextval,$iter1_idx,res,$add5,$bool49,$iter1_iter,$add2,$add3,$add1,$add6,$iter1_array,$add4,$pyjs__trackstack_size_1,$iter1_type;
...
element.innerHTML = html || "";
    ...
    element.style[attr] = value;
		...
		$m['setStyleAttributes'] = function(element) {
			...
			var $iter2_nextval,$iter2_type,attr,$iter2_iter,$pyjs__trackstack_size_1,$iter2_idx,val,$bool50,$iter2_array;
			...
			while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
				...
				if ((($bool50=$p['hasattr']($p['getattr'](element, 'style'), 'setProperty')) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
						false :
		...
		$m['sinkEvents'] = function(element, bits) {
			if ($pyjs.options.arg_count && arguments.length != 2) $pyjs__exception_func_param(arguments.callee.__name__, 2, 2, arguments.length);
			var $iter5_nextval,$bool51,dispEvnt,$iter5_array,$iter3_type,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$21,$20,$iter3_nextval,$22,$iter3_iter,$iter5_idx,event_name,$iter3_array,bit,$15,$16,$17,$iter4_nextval,$18,$19,$iter4_idx,$pyjs__trackstack_size_2,$pyjs__trackstack_size_1,$iter4_array;
...
element.__eventBits = bits;
			...
			while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
				...
				if ((($bool51=$p['op_bitand2'](bits, bit)) === null || $bool51 === false || $bool51 === 0 || $bool51 === '' ?
						false :
...
element['on'+event_name] = null
    ...
    return outer;
		...
		$m['previewEvent'] = function(evt) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $bool54,$cmp4,$cmp3,$bool52,$bool53,$23,$24,ret,$len2,$len3,$sub2,$sub1,preview;
			...
			if ((($bool52=((($cmp3=(($len2=$m['sEventPreviewStack']) === null?$constant_int_0:
		...
		$m['dispatchEventImpl'] = function(event, element, listener) {
			if ($pyjs.options.arg_count && arguments.length != 3) $pyjs__exception_func_param(arguments.callee.__name__, 3, 3, arguments.length);
			var $bool55,$bool56,prevCurrentEvent;
			$pyjs.track={module:'pyjamas.DOM',lineno:1017};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pyjamas.DOM';
			$pyjs.track.lineno=1017;
			$pyjs.track.lineno=579;
			$pyjs.track.lineno=580;
			if ((($bool55=$p['op_eq'](element, $m['sCaptureElem'])) === null || $bool55 === false || $bool55 === 0 || $bool55 === '' ?
					false :
				...
				if ((($bool56=$p['op_eq']($m['eventGetType'](event), 'losecapture')) === null || $bool56 === false || $bool56 === 0 || $bool56 === '' ?
						false :
		...
		$m['insertListItem'] = function(select, item, value, index) {
			...
			$pyjs.track.lineno=594;
			if ((($bool57=!$p['op_is'](value, null)) === null || $bool57 === false || $bool57 === 0 || $bool57 === '' ?
					false :
			...
			if ((($bool58=$p['op_eq'](index, (typeof ($usub1=$constant_int_1)=='number'?
				-$usub1:
				$p['op_usub']($usub1)))) === null || $bool58 === false || $bool58 === 0 || $bool58 === '' ?
					false :
		...
		if ((($bool60=!(($bool59=$p['getattr']($m['pyjd'], 'is_desktop')) === null || $bool59 === false || $bool59 === 0 || $bool59 === '' ?
			false :
