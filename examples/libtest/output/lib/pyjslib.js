 ...
 return $pyjs_type(clsname, bss, mths); 
	...
	$m['object'] = (function(){
		...
		$method = $pyjs__bind_method2('__setattr__', function(name, value) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '290314fc0fa4a99f620c75931d876890') {
	...
	, 3, [null,null,['cls']]);
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== 'b0488c929bad847063fc19df4cc4ca98') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
namespace[name] = module[name];
	...
	$m['BaseException'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== 'c7f30f04cbe0ab4be9edd0727d0e68dc') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['KeyError'] = (function(){
		...
		$method = $pyjs__bind_method2('__str__', function() {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '8171d31c1579fc7e14bcc0de2e9e7b8a') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$p['abs'] = Math.abs;
	...
	$m['Class'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(name) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '64493199a9c00761e6e4959b83ad53c6') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
(function(){
	...
	$m['tuple'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(data) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== 'fae542c0328a79c1e859fb8ac9e9e2fc') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['tuple'].toString = $m['tuple'].__str__;
	$m['NotImplementedType'] = (function(){
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '275ad5ed61b8211b511ed5499a83c385') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$enumerate_array.prototype.$genfunc = $enumerate_array.prototype.next;
	...
	$m['list'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(data) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '6ad7ecb70573ecb2ecda93e68ac7643e') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['list'].toString = $m['list'].__str__;
	$m['slice'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(a1) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '798450a088e7033cd9dcd8aa9e712319') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	, 1, ['args',null,['self'],['a1']]);
		...
		$method = $pyjs__bind_method2('__cmp__', function(x) {
			...
			var $attr82,$attr83,$attr80,$attr81,$attr84,$attr79,$attr78,$attr77,$attr76,$attr74,$attr73,$bool105,$bool104,r,$attr75;
		...
		$method = $pyjs__bind_method2('indices', function(length) {
			...
			if ((($bool124=((($bool122=$or4=((($bool121=$and20=((($cmp29=step)===($cmp30=$constant_int_0)?0:
				...
				slicelength = (typeof ($add45=(typeof ($div1=(typeof ($add43=(typeof ($sub13=stop)==typeof ($sub14=start) && (typeof $sub13=='number'||typeof $sub13=='string')?
					$sub13-$sub14:
					$m['op_sub']($sub13,$sub14)))==typeof ($add44=$constant_int_1) && (typeof $add43=='number'||typeof $add43=='string')?
					$add43+$add44:
					$m['op_add']($add43,$add44)))==typeof ($div2=step) && typeof $div1=='number' && $div2 !== 0?
					$div1/$div2:
					$m['op_div']($div1,$div2)))==typeof ($add46=$constant_int_1) && (typeof $add45=='number'||typeof $add45=='string')?
					$add45+$add46:
				...
				slicelength = (typeof ($add47=(typeof ($div3=(typeof ($sub17=(typeof ($sub15=stop)==typeof ($sub16=start) && (typeof $sub15=='number'||typeof $sub15=='string')?
					...
					$div3/$div4:
					$m['op_div']($div3,$div4)))==typeof ($add48=$constant_int_1) && (typeof $add47=='number'||typeof $add47=='string')?
					$add47+$add48:
...
$m['slice'].toString = $m['slice'].__str__;
	$m['dict'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(seq) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '157239c7d743527ef0435e6ca350d2ef') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
					...
					(typeof $bool134=='object'?
						(typeof $bool134.__nonzero__=='function'?
							...
							(typeof $bool134.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				throw ($m['TypeError']($p['sprintf']('pop expected at most 2 arguments, got %s', (typeof ($add49=$constant_int_1)==typeof ($add50=(($len9=d) === null?$constant_int_0:
...
$m['dict'].__str__ = $m['dict'].__repr__;
	...
	$m['set'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(_data) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '82b18c7f59ebd07b447e38ccad9335f6') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['set']['toString'] = $m['set']['__repr__'];
	$m['frozenset'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(_data) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== 'd7597b0d0afc65ae2c41fe48633c215c') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['frozenset']['toString'] = $m['frozenset']['__repr__'];
	$m['property'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(fget, fset, fdel, doc) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== 'a82c2154eae9e7325f36f3c0a5b4e8a1') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['range'] = function(start, stop, step) {
		...
		if (typeof stop == 'undefined') stop=arguments.callee.__args__[3][1];
		if (typeof step == 'undefined') step=arguments.callee.__args__[4][1];
		var $bool200,$cmp43,$bool195,$cmp44,$bool198,$bool199,$bool193,$bool196,$bool197,$bool194,$bool201,$attr123,$attr124,$attr125,$attr126,$attr127,$attr128,ilow,items,n,r;
...
throw $m['TypeError']("ord() expected string of length 1");
	...
	$m['zip'] = function() {
		...
		var $add51,$add52,$38,$bool220,$bool221,$bool222,n,i,lst,$pyjs_try_err,t,$37,$cmp46,$cmp45;
		n = $m['len'](iterables);
		...
		try {
			while ((($bool221=true) === null || $bool221 === false || $bool221 === 0 || $bool221 === '' ?
				...
				while ((($bool222=((($cmp45=i)===($cmp46=n)?0:
					...
					i = (typeof ($add51=i)==typeof ($add52=$constant_int_1) && (typeof $add51=='number'||typeof $add51=='string')?
						$add51+$add52:
			...
			if ($generator_state[0] == 2) {
				for (;($generator_state[1] > 0 || typeof ($iter22_nextval=($iter22_type?($iter22_type > 0?$iter22_iter.next(true,false):$p['wrapped_next']($iter22_iter)):$iter22_array[$iter22_idx++])) != 'undefined');$generator_state[1] = 0) {
					...
					if ($generator_state[1] == 1) {
						...
						nextIndex = (typeof ($add55=nextIndex)==typeof ($add56=$constant_int_1) && (typeof $add55=='number'||typeof $add55=='string')?
							$add55+$add56:
					...
					if ($generator_state[1] == 3) {
						for (;($generator_state[2] > 0)||((($bool234=true) === null || $bool234 === false || $bool234 === 0 || $bool234 === '' ?
							...
							if ($generator_state[2] == 1) {
								...
								i = (typeof ($add59=i)==typeof ($add60=$constant_int_1) && (typeof $add59=='number'||typeof $add59=='string')?
									$add59+$add60:
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['min'] = function() {
		...
		var $bool239,$iter23_nextval,$iter23_iter,$iter23_type,minValue,item,$49,$iter23_array,$50,$iter23_idx,$bool240,$bool241;
	...
	$m['max'] = function() {
		...
		var $iter24_idx,maxValue,$iter24_type,item,$iter24_array,$bool244,$bool243,$bool242,$51,$52,$iter24_iter,$iter24_nextval;
	...
	$m['complex'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(real, imag) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '25725e4ecef7921503547b22e7b3348a') {
...
r = Math.round(n*x)/n;
	...
	$m['StringBuilder'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '5ec46a453bd561c25a5b215af1809967') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['_parse_int'] = function(s, start, end) {
		if ($pyjs.options.arg_count && arguments.length != 3) $pyjs__exception_func_param(arguments.callee.__name__, 3, 3, arguments.length);
		var $sub23,$sub24,$bool268,result,$bool265,$bool266,$bool267,$mul3,$add69,$pyjs_try_err,msg,$cmp58,$cmp51,$cmp53,$mul4,$cmp55,$cmp54,$cmp57,$cmp56,c,$add72,$add70,$cmp52,$add71,i,$53,$54;
	...
	$m['TemplateFormatter'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(space, template) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== 'd54cd0cb44a5e889560fb448778092c7') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	, 1, [null,null,['self'],['start'],['end'],['level']]);
		...
		$method = $pyjs__bind_method2('_do_build_string', function(start, end, level, out, s) {
			...
			var field_start,rendered,$cmp60,$sub27,$cmp62,$sub30,$add83,$add82,$sub28,$add80,nested,$bool283,$bool287,$bool284,$bool285,$bool282,$add78,$bool280,$bool281,$bool278,$add84,recursive,last_literal,$add81,$add77,$61,$bool275,$62,$bool277,$sub29,$bool276,$or9,$or8,$cmp61,$cmp59,$60,$add75,$add74,$add79,$bool272,$add76,markup_follows,c,$bool274,$bool273,$add73,$bool271,i,$bool279,at_end,$58,$59,$or11,$or10,$assign2,$bool286,$55,$56,$57;
			$assign2 = start;
								...
								(typeof $bool279=='object'?
									(typeof $bool279.__nonzero__=='function'?
										...
										(typeof $bool279.__len__=='function'?
											...
											true ) ) :
									 true ) )) {
							i = (typeof ($add77=i)==typeof ($add78=$constant_int_1) && (typeof $add77=='number'||typeof $add77=='string')?
								$add77+$add78:
						...
						if ((($bool283=$m['op_eq'](c, '{')) === null || $bool283 === false || $bool283 === 0 || $bool283 === '' ?
								...
								(typeof $bool283=='object'?
									(typeof $bool283.__nonzero__=='function'?
									 ...
									 true ) )) {
							recursive = true;
							nested = (typeof ($add79=nested)==typeof ($add80=$constant_int_1) && (typeof $add79=='number'||typeof $add79=='string')?
								$add79+$add80:
	...
	, 1, [null,null,['self'],['start'],['end'],['level'],['out'],['s']]);
		...
		$method = $pyjs__bind_method2('_parse_field', function(start, end) {
			...
			var $cmp64,$cmp65,$cmp66,$add88,$cmp63,$add87,$add86,$add85,$add89,$bool288,$bool289,conversion,$attr160,$68,end_name,$65,$64,$67,$66,$add90,$63,$add94,$bool291,$bool290,$bool293,$bool292,w_msg,$bool294,$add92,$add91,$add93,c,i,$attr159,s,$or13,$or12;
			s = self['template'];
			i = start;
	...
	, 1, [null,null,['self'],['start'],['end']]);
		...
		$method = $pyjs__bind_method2('_get_argument', function(name) {
			...
			var $cmp67,$cmp68,kwarg,stop,$and29,$and28,$bool309,arg_key,$bool308,$attr177,$bool307,index,$attr168,$bool304,end,$bool302,$bool301,$bool300,$attr164,$attr165,$attr167,$attr161,$attr162,$attr163,$attr169,$pyjs_try_err,$69,use_numeric,msg,$bool311,empty,$bool299,$bool298,$add98,$bool306,w_msg,$add95,$add96,$add97,$bool295,c,$bool297,$bool296,$74,$attr180,$bool303,$bool305,$72,$73,$70,$71,$bool310,$attr179,$attr178,i,$attr176,$attr175,$attr174,$attr173,$attr172,$attr171,$attr170,$or15,$or14,$or17,$or16,$attr166,w_arg;
			i = $constant_int_0;
			end = $m['len'](name);
			while ((($bool295=((($cmp67=i)===($cmp68=end)?0:
				...
				i = (typeof ($add95=i)==typeof ($add96=$constant_int_1) && (typeof $add95=='number'||typeof $add95=='string')?
					$add95+$add96:
			...
			if ((($bool310=empty) === null || $bool310 === false || $bool310 === 0 || $bool310 === '' ?
				...
				self.auto_numbering = (typeof ($add97=self['auto_numbering'])==typeof ($add98=$constant_int_1) && (typeof $add97=='number'||typeof $add97=='string')?
					$add97+$add98:
	...
	, 1, [null,null,['self'],['name']]);
		...
		$method = $pyjs__bind_method2('_resolve_lookups', function(w_obj, name, start, end) {
			...
			var $cmp73,$79,got_bracket,$cmp72,$83,$attr182,$cmp69,$add108,$add102,reached,$bool325,$bool324,$bool327,$bool326,$bool321,$bool320,$bool323,$add104,$82,index,$add103,$add106,w_attr,msg,w_item,$bool322,$add101,$add100,$cmp71,$cmp70,$add105,$add99,$add107,$cmp74,w_msg,$attr184,$84,$bool316,$81,$attr181,$80,$and30,$and31,$77,$bool314,$bool315,c,$bool317,$76,$bool312,$75,i,$78,$bool313,$bool318,$bool319,$attr183,$or19,$or18;
			i = start;
	...
	, 1, [null,null,['self'],['w_obj'],['name'],['start'],['end']]);
		...
		$method = $pyjs__bind_method2('formatter_field_name_split', function() {
			...
			var $add110,w_first,$bool329,$bool328,index,end,$attr188,$add109,$attr187,$or20,$or21,$cmp78,$cmp77,$cmp76,$cmp75,$attr186,$86,$85,$attr185,stop,$bool332,$bool333,$bool330,$bool331,c,name,i;
			name = self['template'];
			i = $constant_int_0;
			end = $m['len'](name);
			while ((($bool328=((($cmp75=i)===($cmp76=end)?0:
				...
				i = (typeof ($add109=i)==typeof ($add110=$constant_int_1) && (typeof $add109=='number'||typeof $add109=='string')?
					$add109+$add110:
	...
	, 1, [null,null,['self'],['w_obj'],['conversion']]);
		...
		$method = $pyjs__bind_method2('_render_field', function(start, end, recursive, level) {
			...
			var $attr191,$attr190,$attr193,$attr192,$attr195,$attr194,$attr197,$attr196,$attr199,$attr198,$add112,$cmp80,$add111,conversion,spec,$sub31,$sub32,$attr189,$cmp79,w_obj,$bool338,$bool339,w_entry,$bool336,$bool337,startm1,name,w_rendered,$attr200,spec_start;
			...
			if ((($bool336=!$m['op_is'](self['parser_list_w'], null)) === null || $bool336 === false || $bool336 === 0 || $bool336 === '' ?
				...
				if ((($bool337=$m['op_eq'](level, $constant_int_1)) === null || $bool337 === false || $bool337 === 0 || $bool337 === '' ?
					...
					self.last_end = (typeof ($add111=end)==typeof ($add112=$constant_int_1) && (typeof $add111=='number'||typeof $add111=='string')?
						$add111+$add112:
	...
	$m['BaseFormatter'] = (function(){
		...
		$method = $pyjs__bind_method2('format_int_or_long', function(w_num, kind) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== 'b7202a2c19114ddc062fe03b535f05ea') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['Formatter'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(space, spec) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '8eb903c45cfb74f41dc7640c59a82092') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	, 1, [null,null,['self'],['c']]);
		...
		$method = $pyjs__bind_method2('_parse_spec', function(default_type, default_align) {
			...
			var $add118,$add119,$add116,$add117,$add114,$add115,$add113,tp,$or29,spec,$sub33,$sub35,$sub34,$sub37,$sub36,$sub39,$sub38,presentation_type,$and38,$and39,$and34,$and35,$and36,$and37,$and32,$and33,$attr219,$attr227,$attr226,$attr225,$attr224,$attr223,$attr222,$107,$attr220,$cmp94,$89,$and41,$attr228,$bool358,$bool359,$bool350,$bool351,$bool352,$bool353,$bool354,$bool355,$bool356,$bool357,length,$and40,$and46,$98,$99,$94,$95,$96,$97,$90,$91,$92,$93,$add130,$add131,$bool349,$bool348,$110,$add132,$and45,$and44,$111,$bool347,$bool346,$and43,$and42,the_type,$add127,$add126,$add125,$add124,$add123,$add122,$add121,$add120,$add129,$add128,start_i,$bool376,$bool377,$bool374,$bool375,$bool372,$bool373,$bool370,$bool371,$116,$114,$115,$112,$113,$cmp88,$cmp89,$cmp86,$cmp87,$cmp84,$cmp85,$cmp83,$sub40,$sub41,$sub42,$sub43,$sub44,$sub45,$sub46,$bool361,$bool360,$bool363,$bool362,$bool365,$bool364,$bool367,$bool366,$bool369,$bool368,got_align,$101,$100,$103,$102,$105,$104,$attr221,$106,$109,$108,$cmp91,$cmp90,$cmp93,$cmp92,i,$or33,$or32,$or31,$or30,$or37,$or36,$or35,$or34;
			...
			if ((($bool349=((($bool348=$and32=((((($cmp83=(typeof ($sub33=length)==typeof ($sub34=i) && (typeof $sub33=='number'||typeof $sub33=='string')?
				...
				((typeof $91.__array[$92=(typeof ($add113=i)==typeof ($add114=$constant_int_1) && (typeof $add113=='number'||typeof $add113=='string')?
				$add113+$add114:
				$m['op_add']($add113,$add114))]) != 'undefined'?$91.__array[$92]:
					$91.__getitem__($92)):
					$91.__getitem__((typeof ($add113=i)==typeof ($add114=$constant_int_1) && (typeof $add113=='number'||typeof $add113=='string')?
				$add113+$add114:
				...
				self._align = (typeof ($93=spec).__array != 'undefined'?
					((typeof $93.__array[$94=(typeof ($add115=i)==typeof ($add116=$constant_int_1) && (typeof $add115=='number'||typeof $add115=='string')?
					$add115+$add116:
					$m['op_add']($add115,$add116))]) != 'undefined'?$93.__array[$94]:
						$93.__getitem__($94)):
						$93.__getitem__((typeof ($add115=i)==typeof ($add116=$constant_int_1) && (typeof $add115=='number'||typeof $add115=='string')?
					$add115+$add116:
				...
				self._fill_char = (typeof ($95=spec).__array != 'undefined'?
					((typeof $95.__array[$96=i]) != 'undefined'?$95.__array[$96]:
						$95.__getitem__($96)):
						$95.__getitem__(i));
				i = (typeof ($add117=i)==typeof ($add118=$constant_int_2) && (typeof $add117=='number'||typeof $add117=='string')?
					$add117+$add118:
			...
			if ((($bool367=$m['op_eq']((typeof ($sub45=length)==typeof ($sub46=i) && (typeof $sub45=='number'||typeof $sub45=='string')?
				...
				i = (typeof ($add131=i)==typeof ($add132=$constant_int_1) && (typeof $add131=='number'||typeof $add131=='string')?
					$add131+$add132:
	...
	, 1, [null,null,['self'],['default_type'],['default_align']]);
		...
		$method = $pyjs__bind_method2('_calc_padding', function(string, length) {
			...
			var $attr234,$attr235,$attr236,right,$attr230,$attr231,$attr232,$attr233,$bool383,$bool382,$bool381,$bool380,$sub48,$sub49,$sub52,total,$sub47,$and48,$sub54,$sub53,$sub51,$sub50,$cmp95,$cmp96,$attr229,$div6,$div5,$bool378,$bool379,align,$or39,$or38,$and47,left;
	...
	, 1, [null,null,['self'],['tp']]);
		...
		$method = $pyjs__bind_method2('format_string', function(string) {
			...
			var $117,$bool389,$bool388,$bool387,$bool386,$attr254,$attr255,$attr252,$attr253,$attr250,$attr251,$cmp98,$and49,$attr258,$attr256,$attr257,msg,$bool385,$bool384,$cmp99,$attr247,$attr249,$attr248,$cmp97,$bool390,precision,$bool391,$cmp100,$118,$and50,length;
	...
	, 1, [null,null,['self'],['string']]);
		...
		$method = $pyjs__bind_method2('_get_locale', function(tp) {
			...
			var $attr259,$attr260,$bool392,$bool393,dec,thousands,grouping;
	...
	, 1, [null,null,['self'],['n_prefix'],['sign_char'],['to_number'],['n_number'],['n_remainder'],['has_dec'],['digits']]);
		...
		$method = $pyjs__bind_method2('_fill_digits', function(buf, digits, d_state, n_chars, n_zeros, thousands_sep) {
			...
			$iter30_iter = $m['range']((typeof ($sub65=d_state)==typeof ($sub66=$constant_int_1) && (typeof $sub65=='number'||typeof $sub65=='string')?
				$sub65-$sub66:
	...
	, 1, [null,null,['self'],['buf'],['digits'],['d_state'],['n_chars'],['n_zeros'],['thousands_sep']]);
		...
		$method = $pyjs__bind_method2('_group_digits', function(spec, digits) {
			...
			var $sub72,$attr314,$attr313,$attr312,$attr311,$attr310,$cmp106,$cmp107,$cmp104,$cmp105,$cmp103,done,n_ts,$sub74,min_width,$sub77,previous,group,$cmp108,$sub71,ts,grouping_state,$bool413,$bool412,$bool411,$bool410,$bool415,$bool414,$attr304,count,$attr306,$attr307,$attr303,$attr308,$attr309,n_chars,$sub79,n_zeros,$sub78,$sub75,$122,$121,$sub76,buf,final_grouping,$sub73,groupings,$and54,$and53,$bool416,$bool408,$bool409,$add156,need_separator,$add155,$sub80,$attr305,grouping,left;
			buf = $p['list']([]);
			...
			while ((($bool408=true) === null || $bool408 === false || $bool408 === 0 || $bool408 === '' ?
				...
				if ((($bool409=((($cmp103=group)===($cmp104=$constant_int_0)?0:
					...
					grouping_state = (typeof ($add155=grouping_state)==typeof ($add156=$constant_int_1) && (typeof $add155=='number'||typeof $add155=='string')?
						$add155+$add156:
	...
	, 1, [null,null,['self'],['s']]);
		...
		$method = $pyjs__bind_method2('_fill_number', function(spec, num, to_digits, to_prefix, fill_char, to_remainder, upper, grouped_digits) {
			...
			var $attr317,$attr315,$bool423,$attr316,$attr319,$attr318,$bool424,$add159,$add157,out,$attr327,pref,$attr328,$bool419,$bool418,$attr322,$attr323,$attr320,$attr326,$attr324,$attr325,$attr336,$cmp113,$add160,$cmp114,$bool425,$attr340,$attr341,$attr342,$attr338,stop,$attr345,$attr346,$bool426,$bool427,$123,$attr333,sign,$127,$126,$125,$124,digits,$attr337,$attr321,$attr343,$attr331,$attr344,$attr330,$128,$attr339,$bool428,$bool429,$attr335,$attr334,$add158,$attr332,$bool422,$attr329,$bool420,$bool421;
			out = self['_builder']();
	...
	, 1, [null,null,['self'],['spec'],['num'],['to_digits'],['to_prefix'],['fill_char'],['to_remainder'],['upper'],['grouped_digits', null]]);
		...
		$method = $pyjs__bind_method2('_format_int_or_long', function(w_num, kind) {
			...
			var upper,$attr359,$attr358,n_remainder,$bool439,$attr353,$attr352,$attr351,$attr350,$attr357,$attr356,$attr355,$attr354,$sub84,n_digits,result,$sub83,$130,fill,sign_char,tp,$bool431,$bool430,$bool433,$bool432,$bool435,$bool434,$bool437,$bool436,msg,$or43,$or40,to_prefix,spec,$attr348,$attr349,$add163,$add162,$add161,$attr360,$attr347,$or42,$129,base,$bool438,$add164,$or41,value,to_remainder,$bool440,$bool441,$bool442,n_prefix,skip_leading,to_numeric;
					...
					((typeof $129.__array[$130=$constant_int_0]) != 'undefined'?$129.__array[$130]:
						...
						(typeof $bool441=='object'?
							(typeof $bool441.__nonzero__=='function'?
							 ...
							 true ) )) {
					sign_char = '-';
					skip_leading = (typeof ($add161=skip_leading)==typeof ($add162=$constant_int_1) && (typeof $add161=='number'||typeof $add161=='string')?
						$add161+$add162:
						$m['op_add']($add161,$add162));
					to_prefix = (typeof ($add163=to_prefix)==typeof ($add164=$constant_int_1) && (typeof $add163=='number'||typeof $add163=='string')?
						$add163+$add164:
	...
	, 1, [null,null,['self'],['w_num'],['kind']]);
		...
		$method = $pyjs__bind_method2('_int_to_base', function(base, value) {
			...
			var $cmp120,$sub95,$cmp122,$add170,$add171,$mod6,$sub94,$add169,$mod5,$sub85,$sub86,$sub87,$sub104,$sub105,$sub106,$sub107,$sub108,$floordiv5,$sub88,$sub89,$cmp121,$floordiv6,negative,$cmp119,$bool447,$bool452,$bool451,$bool450,$add172,$sub101,digit,$add168,$cmp115,$cmp117,$cmp116,$sub99,$cmp118,$add167,$add166,$add165,$sub93,$sub92,$sub91,$sub97,$sub96,$mul9,$mul8,$mul7,$mul6,$mul5,$sub98,buf,mod,$sub100,$sub103,$mul10,i,$sub102,$bool444,$bool445,$bool446,$floordiv4,$floordiv3,$sub90,$bool443,div,$bool448,$bool449;
			...
			value = $p['abs'](value);
			buf = (typeof ($mul7=$p['list'](['\x00']))==typeof ($mul8=(typeof ($add165=(typeof ($mul5=$constant_int_8)==typeof ($mul6=$constant_int_8) && typeof $mul5=='number'?
				$mul5*$mul6:
				$m['op_mul']($mul5,$mul6)))==typeof ($add166=$constant_int_6) && (typeof $add165=='number'||typeof $add165=='string')?
				$add165+$add166:
			...
			while ((($bool444=true) === null || $bool444 === false || $bool444 === 0 || $bool444 === '' ?
				...
				digit = $p['abs'](mod);
				digit = (typeof ($add167=digit)==typeof ($add168=((($bool445=((($cmp117=digit)===($cmp118=$constant_int_10)?0:
			...
			if ((($bool448=$m['op_eq'](base, $constant_int_2)) === null || $bool448 === false || $bool448 === 0 || $bool448 === '' ?
				...
				buf.__setitem__((typeof ($sub99=i)==typeof ($sub100=$constant_int_1) && (typeof $sub99=='number'||typeof $sub99=='string')?
					$sub99-$sub100:
					$m['op_sub']($sub99,$sub100)), $m['chr']((typeof ($add169=$m['ord']('0'))==typeof ($add170=(typeof ($mod5=base)==typeof ($mod6=$constant_int_10) && typeof $mod5=='number'?
				...
				if ((($bool451=((($cmp119=base)===($cmp120=$constant_int_10)?0:
					...
					buf.__setitem__((typeof ($sub101=i)==typeof ($sub102=$constant_int_2) && (typeof $sub101=='number'||typeof $sub101=='string')?
						$sub101-$sub102:
						$m['op_sub']($sub101,$sub102)), $m['chr']((typeof ($add171=$m['ord']('0'))==typeof ($add172=(typeof ($floordiv5=base)==typeof ($floordiv6=$constant_int_10) && typeof $floordiv5=='number' && $floordiv6 !== 0?
	...
	, 1, [null,null,['self'],['base'],['value']]);
		...
		$method = $pyjs__bind_method2('format_int_or_long', function(w_num, kind) {
			...
			var $bool455,tp,$bool457,$bool456,$or48,$bool454,$bool453,$or49,$or46,$or47,$bool459,$bool458,$attr362,$bool468,$attr361,w_float,$or52,$bool462,$bool463,$bool460,$bool461,$bool466,$bool467,$bool464,$bool465,$or44,$or51,$or50,$or53,$or45,$or55,$or54,$or57,$or56;
	...
	, 1, [null,null,['self'],['w_num'],['kind']]);
		...
		$method = $pyjs__bind_method2('_parse_number', function(s, i) {
			...
			var $cmp124,$cmp125,$cmp126,$cmp127,$cmp123,$add173,$add174,$cmp129,rest,$131,$132,$133,$134,$bool471,$bool470,$bool472,length,$cmp130,$cmp128,$add175,dec_point,$add176,$bool469,$and58,$and57,$and55,$and56;
			length = $m['len'](s);
					...
					(typeof $bool470=='object'?
						(typeof $bool470.__nonzero__=='function'?
							...
							(typeof $bool470.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				i = (typeof ($add173=i)==typeof ($add174=$constant_int_1) && (typeof $add173=='number'||typeof $add173=='string')?
					$add173+$add174:
					...
					(typeof $bool472=='object'?
						(typeof $bool472.__nonzero__=='function'?
							...
							(typeof $bool472.__len__=='function'?
								...
								true ) ) :
						 true ) )) {
				rest = (typeof ($add175=rest)==typeof ($add176=$constant_int_1) && (typeof $add175=='number'||typeof $add175=='string')?
					$add175+$add176:
	...
	, 1, [null,null,['self'],['s'],['i']]);
		...
		$method = $pyjs__bind_method2('_format_float', function(w_float) {
			...
			var $add178,$attr370,$attr373,$attr372,n_remainder,sign,$add177,n_digits,tp,$sub109,$135,$136,$attr374,$bool479,add_pct,$bool475,$bool474,$bool476,to_number,$bool473,default_precision,msg,have_dec_point,fill,spec,$bool480,$attr368,$attr369,$attr366,$attr367,$attr364,$attr365,$attr363,$sub112,$sub111,$sub110,$bool478,digits,$mul12,$mul11,value,to_remainder,flags,$attr371,$bool477,result;
	...
	, 1, [null,null,['self'],['w_float']]);
		...
		$method = $pyjs__bind_method2('format_float', function(w_float) {
			...
			var $attr375,$attr376,$or60,$or61,$or62,$or63,$or64,$or65,$or66,tp,$bool490,$bool481,$bool482,$bool483,$bool484,$bool485,$bool486,$bool487,$bool488,$bool489,$or59,$or58;
	...
	, 1, [null,null,['self'],['w_float']]);
		...
		$method = $pyjs__bind_method2('_format_complex', function(w_complex) {
			...
			self['_calc_padding'](self['empty'], (typeof ($add183=(typeof ($add181=(typeof ($add179=re_spec['n_total'])==typeof ($add180=im_spec['n_total']) && (typeof $add179=='number'||typeof $add179=='string')?
				$add179+$add180:
				$m['op_add']($add179,$add180)))==typeof ($add182=$constant_int_1) && (typeof $add181=='number'||typeof $add181=='string')?
				$add181+$add182:
				$m['op_add']($add181,$add182)))==typeof ($add184=(typeof ($mul13=add_parens)==typeof ($mul14=$constant_int_2) && typeof $mul13=='number'?
				$mul13*$mul14:
	...
	, 1, [null,null,['self'],['w_complex']]);
		...
		$method = $pyjs__bind_method2('format_complex', function(w_complex) {
			...
			var $or67,$or68,$or69,tp,$bool516,$bool517,$bool514,$bool515,$bool512,$bool513,$bool510,$bool511,$attr423,$attr424,$or74,$or73,$or72,$or71,$or70,$bool509;
	...
	$m['StringFormatSpace'] = (function(){
		...
		$method = $pyjs__bind_method2('format', function(w_obj, spec) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '12b2e46cf7d4b317ec2505a1e98dd739') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['formatd'] = function(x, code, precision, flags) {
		...
		var $iter33_iter,sign,$152,$153,$150,$151,$and63,$154,$sub122,$sub123,alt,$sub121,$mod9,$sub124,$cmp132,$bool538,$iter33_type,fmt,$iter33_test,$bool529,$add189,$add188,$iter33_idx,$bool530,$bool531,$bool532,$bool533,$add185,$bool535,$add187,$add186,$iter33_nextval,$cmp134,$cmp133,$mod10,$cmp131,$149,$iter33_array,c,$add190,idx,$bool534,s,$and64,$bool536,$bool537;
		...
		if ((($bool531=$m['op_bitand2'](flags, $m['DTSF_ADD_DOT_0'])) === null || $bool531 === false || $bool531 === 0 || $bool531 === '' ?
				...
				(typeof $bool531=='object'?
					(typeof $bool531.__nonzero__=='function'?
					 ...
					 true ) )) {
			idx = $m['len'](s);
			$iter33_iter = $m['range']($m['len'](s), $constant_int_0, (typeof ($usub27=$constant_int_1)=='number'?
				-$usub27:
				$m['op_usub']($usub27)));
							...
							(typeof $bool533=='object'?
								(typeof $bool533.__nonzero__=='function'?
									...
									(typeof $bool533.__len__=='function'?
										...
										true ) ) :
								 true ) )) {
						idx = (typeof ($add185=idx)==typeof ($add186=$constant_int_1) && (typeof $add185=='number'||typeof $add185=='string')?
							$add185+$add186:
							$m['op_add']($add185,$add186));
					}
					s = (typeof ($add187=$p['__getslice'](s, 0, idx))==typeof ($add188=$m['sprintf']('%02d', $p['int']($p['__getslice'](s, idx, null)))) && (typeof $add187=='number'||typeof $add187=='string')?
						$add187+$add188:
