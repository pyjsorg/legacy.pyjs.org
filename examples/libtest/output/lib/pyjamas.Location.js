...
$pyjs.loaded_modules['pyjamas.Location'] = function (__mod_name__) {
	...
	try {
		...
		$m['Location'] = (function(){
			...
			$cls_definition.__md5__ = 'c81ce7704488ff613bf6af0764782eca';
			...
			$method = $pyjs__bind_method2('__init__', function(location) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'c81ce7704488ff613bf6af0764782eca') {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getSearch', function() {
				...
				$pyjs.track.lineno=67;
				var $pyjs__ret = ((($bool7=$or3=$p['getattr']($p['getattr'](self, 'location'), 'search')) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
					false :
					(typeof $bool7=='object'?
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getSearchDict', function() {
				...
				if ((($bool8=$p['op_is']($p['getattr'](self, 'searchDict'), null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
						false :
						(typeof $bool8=='object'?
