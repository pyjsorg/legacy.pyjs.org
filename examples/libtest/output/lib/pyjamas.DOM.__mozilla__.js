...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
    ...
    return evt.relatedTarget ? evt.relatedTarget : null;
		...
		$m['eventGetType'] = function(event) {
			...
			$pyjs.track.lineno=27;
			if ((($bool30=$p['op_eq'](etype, 'DOMMouseScroll')) === null || $bool30 === false || $bool30 === 0 || $bool30 === '' ?
					false :
    ...
    return child ? child : null;
		...
		$m['getLastChild'] = function(elem) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $and9,$bool35,$and12,$bool33,$and10,$and11,$bool34,child;
					...
					(typeof $bool34.__nonzero__=='function'?
						...
						(typeof $bool34.__len__=='function'?
							($bool34.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?!$p['op_eq']($p['getattr'](child, 'nodeType'), $constant_int_1):$and11)) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
					false :
    ...
    return i;
		...
		$m['getPrevSibling'] = function(elem) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $and13,sib,$and14,$bool38,$bool39;
					...
					(typeof $bool38.__nonzero__=='function'?
						...
						(typeof $bool38.__len__=='function'?
							($bool38.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?!$p['op_eq']($p['getattr'](sib, 'nodeType'), $constant_int_1):$and13)) === null || $bool39 === false || $bool39 === 0 || $bool39 === '' ?
					false :
	...
	, 1, [null,null,['self'],['elem']]);
			...
			$method = $pyjs__bind_method2('next', function() {
				...
				if ((($bool41=!(($bool40=$p['getattr'](self, 'child')) === null || $bool40 === false || $bool40 === 0 || $bool40 === '' ?
					false :
	...
	, 1, [null,null,['self'],['elem'],['all_nodes', false]]);
			...
			$method = $pyjs__bind_method2('next', function() {
				...
				var $bool47,$bool46,$bool45,$bool44,$bool43,$cmp2,nextSibling,firstChild,$bool48,$bool49,$len1,$cmp1;
				$pyjs.track={module:'pyjamas.DOM', lineno:727};$pyjs.trackstack.push($pyjs.track);
				$pyjs.track.module='pyjamas.DOM';
				$pyjs.track.lineno=727;
				$pyjs.track.lineno=728;
				if ((($bool44=!(($bool43=$p['getattr'](self, 'child')) === null || $bool43 === false || $bool43 === 0 || $bool43 === '' ?
					false :
				...
				if ((($bool45=$p['getattr'](self, 'all_nodes')) === null || $bool45 === false || $bool45 === 0 || $bool45 === '' ?
						false :
				...
				if ((($bool46=!$p['op_is'](firstChild, null)) === null || $bool46 === false || $bool46 === 0 || $bool46 === '' ?
						false :
					...
					if ((($bool47=!$p['op_is'](nextSibling, null)) === null || $bool47 === false || $bool47 === 0 || $bool47 === '' ?
							false :
				...
				else if ((($bool48=!$p['op_is'](nextSibling, null)) === null || $bool48 === false || $bool48 === 0 || $bool48 === '' ?
						false :
				...
				else if ((($bool49=((($cmp1=(($len1=$p['getattr'](self, 'stack')) === null?$constant_int_0:
    ...
    while (cur && (cur.nodeType == 1)) {
		...
		$m['mash_name_for_glib'] = function(name, joiner) {
			...
			var c,$iter1_nextval,$iter1_idx,res,$add5,$iter1_iter,$add2,$add3,$add1,$add6,$iter1_array,$add4,$pyjs__trackstack_size_1,$bool50,$iter1_type;
			...
			while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
				...
				if ((($bool50=c['isupper']()) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
						false :
...
element.innerHTML = html || "";
    ...
    element.style[attr] = value;
		...
		$m['setStyleAttributes'] = function(element) {
			...
			var $iter2_nextval,$iter2_type,attr,$iter2_iter,$pyjs__trackstack_size_1,$iter2_idx,val,$iter2_array,$bool51;
			...
			while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
				...
				if ((($bool51=$p['hasattr']($p['getattr'](element, 'style'), 'setProperty')) === null || $bool51 === false || $bool51 === 0 || $bool51 === '' ?
						false :
		...
		$m['sinkEvents'] = function(element, bits) {
			if ($pyjs.options.arg_count && arguments.length != 2) $pyjs__exception_func_param(arguments.callee.__name__, 2, 2, arguments.length);
			var $iter5_nextval,$bool52,dispEvnt,$iter5_array,$iter3_type,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$21,$20,$iter3_nextval,$22,$iter3_iter,$iter5_idx,event_name,$iter3_array,bit,$15,$16,$17,$iter4_nextval,$18,$19,$iter4_idx,$pyjs__trackstack_size_2,$pyjs__trackstack_size_1,$iter4_array;
...
element.__eventBits = bits;
			...
			while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
				...
				if ((($bool52=$p['op_bitand2'](bits, bit)) === null || $bool52 === false || $bool52 === 0 || $bool52 === '' ?
						false :
...
element['on'+event_name] = null
    ...
    return outer;
		...
		$m['previewEvent'] = function(evt) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $bool54,$cmp4,$cmp3,$bool53,$23,$24,ret,$bool55,$len2,$len3,$sub2,$sub1,preview;
			...
			if ((($bool53=((($cmp3=(($len2=$m['sEventPreviewStack']) === null?$constant_int_0:
				...
				(typeof $cmp3==typeof $cmp4 && ((typeof $cmp3 == 'number')||(typeof $cmp3 == 'string')||(typeof $cmp3 == 'boolean'))?
					...
					$p['cmp']($cmp3, $cmp4))) == 1)) === null || $bool53 === false || $bool53 === 0 || $bool53 === '' ?
					false :
				...
				if ((($bool55=!(($bool54=ret) === null || $bool54 === false || $bool54 === 0 || $bool54 === '' ?
					false :
		...
		$m['dispatchEventImpl'] = function(event, element, listener) {
			if ($pyjs.options.arg_count && arguments.length != 3) $pyjs__exception_func_param(arguments.callee.__name__, 3, 3, arguments.length);
			var $bool57,$bool56,prevCurrentEvent;
			$pyjs.track={module:'pyjamas.DOM',lineno:1017};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pyjamas.DOM';
			$pyjs.track.lineno=1017;
			$pyjs.track.lineno=579;
			$pyjs.track.lineno=580;
			if ((($bool56=$p['op_eq'](element, $m['sCaptureElem'])) === null || $bool56 === false || $bool56 === 0 || $bool56 === '' ?
					false :
				...
				if ((($bool57=$p['op_eq']($m['eventGetType'](event), 'losecapture')) === null || $bool57 === false || $bool57 === 0 || $bool57 === '' ?
						false :
		...
		$m['insertListItem'] = function(select, item, value, index) {
			...
			$pyjs.track.lineno=594;
			if ((($bool58=!$p['op_is'](value, null)) === null || $bool58 === false || $bool58 === 0 || $bool58 === '' ?
					false :
			...
			if ((($bool59=$p['op_eq'](index, (typeof ($usub1=$constant_int_1)=='number'?
				-$usub1:
				$p['op_usub']($usub1)))) === null || $bool59 === false || $bool59 === 0 || $bool59 === '' ?
					false :
    ...
    return evt.detail || 0;
		...
		if ((($bool61=!(($bool60=$p['getattr']($m['pyjd'], 'is_desktop')) === null || $bool60 === false || $bool60 === 0 || $bool60 === '' ?
			false :
