...
$pyjs.loaded_modules['I18N.domain.subdomain.en_US'] = function (__mod_name__) {
	...
	try {
		$m.__track_lines__[1] = 'I18N.domain.subdomain.en_US.py, line 1:\n    ';
		$m.__track_lines__[3] = 'I18N.domain.subdomain.en_US.py, line 3:\n    class I18N(object):';
		$m.__track_lines__[4] = 'I18N.domain.subdomain.en_US.py, line 4:\n    def example(self):';
		$m.__track_lines__[5] = 'I18N.domain.subdomain.en_US.py, line 5:\n    return "This is a subdomain en_US example"';
		$m.__track_lines__[7] = 'I18N.domain.subdomain.en_US.py, line 7:\n    import I18N.en_US as parent_parent';
		$m.__track_lines__[8] = 'I18N.domain.subdomain.en_US.py, line 8:\n    import I18N.domain.en_US as parent';
		$m.__track_lines__[9] = 'I18N.domain.subdomain.en_US.py, line 9:\n    import I18N.domain.subdomain as dom';
		$m.__track_lines__[10] = "I18N.domain.subdomain.en_US.py, line 10:\n    dom.i18n = type('I18N', (I18N, dom.I18N, parent.I18N, parent_parent.I18N), {})()";


		$pyjs.track.module='I18N.domain.subdomain.en_US';
		$pyjs.track.lineno=1;
		$pyjs.track.lineno=3;
		$m['I18N'] = (function(){
			...
			$method = $pyjs__bind_method2('example', function() {
				...
				$pyjs.track={module:'I18N.domain.subdomain.en_US', lineno:4};$pyjs.trackstack.push($pyjs.track);
				$pyjs.track.module='I18N.domain.subdomain.en_US';
				$pyjs.track.lineno=4;
				$pyjs.track.lineno=5;
				$pyjs.track.lineno=5;
				var $pyjs__ret = 'This is a subdomain en_US example';
