...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
    ...
    return evt.toElement ? evt.toElement : null;
		...
		$m['eventGetType'] = function(event) {
			...
			if ((($bool30=$p['op_eq'](etype, 'propertychange')) === null || $bool30 === false || $bool30 === 0 || $bool30 === '' ?
					false :
    ...
    while (cur && (cur.nodeType == 1)) {
		...
		$m['mash_name_for_glib'] = function(name, joiner) {
			...
			var c,$iter1_nextval,$bool52,$iter1_idx,res,$add5,$iter1_iter,$add2,$add3,$add1,$add6,$iter1_array,$add4,$pyjs__trackstack_size_1,$iter1_type;
...
element.innerHTML = html || "";
    ...
    element.style[attr] = value;
		...
		$m['setStyleAttributes'] = function(element) {
			...
			var $iter2_nextval,$iter2_type,attr,$iter2_iter,$bool53,$pyjs__trackstack_size_1,$iter2_idx,val,$iter2_array;
			...
			while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
				...
				if ((($bool53=$p['hasattr']($p['getattr'](element, 'style'), 'setProperty')) === null || $bool53 === false || $bool53 === 0 || $bool53 === '' ?
						false :
		...
		$m['sinkEvents'] = function(element, bits) {
			if ($pyjs.options.arg_count && arguments.length != 2) $pyjs__exception_func_param(arguments.callee.__name__, 2, 2, arguments.length);
			var $bool54,$iter5_nextval,dispEvnt,$iter5_array,$iter3_type,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,bit,$iter3_idx,$iter3_nextval,$iter3_iter,$iter5_idx,event_name,$9,$8,$iter3_array,$6,$7,$4,$5,$3,$10,$iter4_nextval,$iter4_idx,$pyjs__trackstack_size_2,$pyjs__trackstack_size_1,$iter4_array;
...
element.__eventBits = bits;
			...
			while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
				...
				if ((($bool54=$p['op_bitand2'](bits, bit)) === null || $bool54 === false || $bool54 === 0 || $bool54 === '' ?
						false :
					...
					$iter4_iter = (typeof ($5=(typeof ($3=$p['getattr']($m['Event'], 'eventbits')).__array != 'undefined'?
...
element['on'+event_name] = dispEvnt
					...
					$pyjs__trackstack_size_2=$pyjs.trackstack.length;
					$iter5_iter = (typeof ($9=(typeof ($7=$p['getattr']($m['Event'], 'eventbits')).__array != 'undefined'?
...
element['on'+event_name] = null
    ...
    return elem.outerHTML;
		...
		$m['previewEvent'] = function(evt) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $bool55,$bool56,$bool57,$11,$cmp3,$cmp4,ret,$len2,$len3,$12,$sub2,$sub1,preview;
			...
			if ((($bool55=((($cmp3=(($len2=$m['sEventPreviewStack']) === null?$constant_int_0:
				...
				preview = (typeof ($11=$m['sEventPreviewStack']).__array != 'undefined'?
					((typeof $11.__array[$12=(typeof ($sub1=(($len3=$m['sEventPreviewStack']) === null?$constant_int_0:
					...
					$p['op_sub']($sub1,$sub2))]) != 'undefined'?$11.__array[$12]:
						$11.__getitem__($12)):
						$11.__getitem__((typeof ($sub1=(($len3=$m['sEventPreviewStack']) === null?$constant_int_0:
					(typeof $len3.__array != 'undefined' ? new $p['int']($len3.__array.length):
						(typeof $len3.__len__ == 'function'?$len3.__len__():
							(typeof $len3.length != 'undefined'? new $p['int']($len3.length):
								$p['len']($len3))))))==typeof ($sub2=$constant_int_1) && (typeof $sub1=='number'||typeof $sub1=='string')?
		...
		$m['dispatchEventImpl'] = function(event, element, listener) {
			if ($pyjs.options.arg_count && arguments.length != 3) $pyjs__exception_func_param(arguments.callee.__name__, 3, 3, arguments.length);
			var $bool58,$bool59,prevCurrentEvent;
			$pyjs.track={module:'pyjamas.DOM',lineno:1017};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pyjamas.DOM';
			$pyjs.track.lineno=1017;
			$pyjs.track.lineno=579;
			$pyjs.track.lineno=580;
			if ((($bool58=$p['op_eq'](element, $m['sCaptureElem'])) === null || $bool58 === false || $bool58 === 0 || $bool58 === '' ?
					false :
				...
				if ((($bool59=$p['op_eq']($m['eventGetType'](event), 'losecapture')) === null || $bool59 === false || $bool59 === 0 || $bool59 === '' ?
						false :
