...
$pyjs.loaded_modules['puremvc.interfaces'] = function (__mod_name__) {
	...
	var $m = $pyjs.loaded_modules["puremvc.interfaces"];
	$m.__repr__ = function() { return "<module: puremvc.interfaces>"; };
	$m.__was_initialized__ = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'puremvc.interfaces';
	$m.__name__ = __mod_name__;
	$pyjs.loaded_modules['puremvc']['interfaces'] = $pyjs.loaded_modules['puremvc.interfaces'];
