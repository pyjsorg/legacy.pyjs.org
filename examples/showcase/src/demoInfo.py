...
def getDemos():
    demos = []
    demos.append({"name" : "deepLink",
                  "title" : "DeepLink",
                  "section" : "other",
                  "doc" : """This example shows you how to set and get deep links (also known as Tokens) """,
...
""",
    ...
    demos.append({"name" : "captionPanel",
                  "title" : "ui.CaptionPanel",
                  "section" : "panels",
                  "doc" : """The ``ui.CaptionPanel`` class implements a panel that displays a caption in the upper left corner of the border.
...
Also, note that FormPanel is a subclass of SimplePanel.  This means that if you want a form with more than one widget, you will need to add a subclass of  ComplexPanel as the child widget of the FormPanel.  An instance of  VerticalPanel is used in this example. """,
                  "src" : """<!DOCTYPE HTML PUBLIC "-//W3C//DTD                           HTML 3.2 Final//EN"
...
If you want a TextArea that adjusts its size after its content, then have a look at the AutoTextArea below. It also shows you how to catch certain keystrokes such as ctrl-enter. """,
                  "src" : """<!DOCTYPE HTML PUBLIC "-//W3C//DTD                           HTML 3.2 Final//EN"
