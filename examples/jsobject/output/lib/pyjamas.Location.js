...
$pyjs.loaded_modules['pyjamas.Location'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getSearch', function() {
			...
			var $or4,$bool7,$or3;
			return ((($bool7=$or3=$p['getattr']($p['getattr'](self, 'location'), 'search')) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
				false :
				(typeof $bool7=='object'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getSearchDict', function() {
			...
			var search,$bool8;
			if ((($bool8=($p['getattr'](self, 'searchDict') === null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
					false :
					(typeof $bool8=='object'?
