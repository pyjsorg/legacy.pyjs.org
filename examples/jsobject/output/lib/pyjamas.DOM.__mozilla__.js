...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
	...
	$m['getLastChild'] = function(elem) {
		var $and9,$bool35,$and12,$bool33,$and10,$and11,$bool34,child,$eq18,$eq17;
				...
				(typeof $bool34.__nonzero__=='function'?
					...
					(typeof $bool34.__len__=='function'?
						($bool34.__len__()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq17=$p['getattr'](child, 'nodeType'))===($eq18=1)&&$eq17===null?true:
	...
	$m['getPrevSibling'] = function(elem) {
		var $and13,$eq20,$eq19,sib,$and14,$bool38,$bool39;
				...
				(typeof $bool38.__nonzero__=='function'?
					...
					(typeof $bool38.__len__=='function'?
						($bool38.__len__()>0 ?
							...
							false) :
						true ) ) :
				 true ) )?!(($eq19=$p['getattr'](sib, 'nodeType'))===($eq20=1)&&$eq19===null?true:
	...
	, 1, [null,null,['self'],['elem'],['all_nodes', false]]);
		...
		$method = $pyjs__bind_method2('next', function() {
			...
			else if ((($bool49=((($cmp1=(($len1=$p['getattr'](self, 'stack')) === null?0:
	...
	$m['mash_name_for_glib'] = function(name, joiner) {
		...
		var c,$iter1_nextval,$iter1_idx,res,$iter1_iter,$add2,$add3,$add1,$add6,$iter1_array,$add4,$add5,$bool50,$iter1_type;
		res = '';
		$iter1_iter = name;
...
element.innerHTML = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$iter2_idx,val,$iter2_array,$bool51;
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$bool52,dispEvnt,$iter5_array,$9,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$iter3_nextval,$iter3_iter,$iter5_idx,event_name,$iter3_array,bit,$14,$15,$16,$10,$11,$12,$13,$iter4_nextval,$iter4_idx,$iter3_type,$iter4_array;
element.__eventBits = bits;
		...
		while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
			bit = $iter3_nextval;
			if ((($bool52=(bits)&(bit)) === null || $bool52 === false || $bool52 === 0 || $bool52 === '' ?
					false :
...
element['on'+event_name] = null
	...
	$m['previewEvent'] = function(evt) {
		var $bool54,$cmp4,$17,$cmp3,$bool53,$18,ret,$bool55,$len2,$len3,$sub2,$sub1,preview;
		ret = true;
		if ((($bool53=((($cmp3=(($len2=$m['sEventPreviewStack']) === null?0:
	...
	$m['dispatchEventImpl'] = function(event, element, listener) {
		var $eq21,$bool57,$bool56,$eq23,$eq22,$eq24,prevCurrentEvent;
		if ((($bool56=(($eq21=element)===($eq22=$m['sCaptureElem'])&&$eq21===null?true:
			($eq21===null?false:($eq22===null?false:
				((typeof $eq21=='object'||typeof $eq21=='function')&&typeof $eq21.__cmp__=='function'?$eq21.__cmp__($eq22) === 0:
					((typeof $eq22=='object'||typeof $eq22=='function')&&typeof $eq22.__cmp__=='function'?$eq22.__cmp__($eq21) === 0:
						$eq21==$eq22)))))) === null || $bool56 === false || $bool56 === 0 || $bool56 === '' ?
				false :
				(typeof $bool56=='object'?
					(typeof $bool56.__nonzero__=='function'?
						...
						(typeof $bool56.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool57=(($eq23=$m['eventGetType'](event))===($eq24='losecapture')&&$eq23===null?true:
				($eq23===null?false:($eq24===null?false:
					((typeof $eq23=='object'||typeof $eq23=='function')&&typeof $eq23.__cmp__=='function'?$eq23.__cmp__($eq24) === 0:
						((typeof $eq24=='object'||typeof $eq24=='function')&&typeof $eq24.__cmp__=='function'?$eq24.__cmp__($eq23) === 0:
							$eq23==$eq24)))))) === null || $bool57 === false || $bool57 === 0 || $bool57 === '' ?
					false :
	...
	$m['insertListItem'] = function(select, item, value, index) {
		var option,$bool58,$bool59,$eq25,$eq26;
		option = $m['createElement']('OPTION');
		$m['setInnerText'](option, item);
		if ((($bool58=(value !== null)) === null || $bool58 === false || $bool58 === 0 || $bool58 === '' ?
				false :
		...
		if ((($bool59=(($eq25=index)===($eq26=(typeof ($usub1=1)=='number'?
			-$usub1:
			...
			($eq25===null?false:($eq26===null?false:
				((typeof $eq25=='object'||typeof $eq25=='function')&&typeof $eq25.__cmp__=='function'?$eq25.__cmp__($eq26) === 0:
					((typeof $eq26=='object'||typeof $eq26=='function')&&typeof $eq26.__cmp__=='function'?$eq26.__cmp__($eq25) === 0:
						$eq25==$eq26)))))) === null || $bool59 === false || $bool59 === 0 || $bool59 === '' ?
				false :
