...
$pyjs.loaded_modules['pyjamas.DOM'] = function (__mod_name__) {
	...
	$m['mash_name_for_glib'] = function(name, joiner) {
		...
		var c,$iter1_nextval,$bool52,$iter1_idx,res,$iter1_iter,$add2,$add3,$add1,$add6,$iter1_array,$add4,$add5,$iter1_type;
		res = '';
		$iter1_iter = name;
...
element.innerHTML = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$bool53,$iter2_idx,val,$iter2_array;
	...
	$m['sinkEvents'] = function(element, bits) {
		var $bool54,$iter5_nextval,dispEvnt,$iter5_array,$iter3_type,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,bit,$iter3_idx,$iter3_nextval,$iter3_iter,$iter5_idx,event_name,$9,$8,$iter3_array,$6,$7,$4,$5,$3,$10,$iter4_nextval,$iter4_idx,$iter4_array;
