...
element.innerHTML = html || "";
	...
	$m['setStyleAttributes'] = function(element) {
		...
		var $iter2_nextval,$iter2_type,attr,$iter2_iter,$iter2_idx,val,$bool50,$iter2_array;
	...
	$m['sinkEvents'] = function(element, bits) {
		var $iter5_nextval,$bool51,$iter3_type,dispEvnt,$iter5_array,$9,$iter5_iter,$iter4_type,$iter5_type,$iter4_iter,$iter3_idx,$iter3_nextval,$iter3_iter,$iter5_idx,event_name,$iter3_array,bit,$14,$15,$16,$10,$11,$12,$13,$iter4_nextval,$iter4_idx,$iter4_array;
...
element['on'+event_name] = null
	...
	$m['dispatchEventImpl'] = function(event, element, listener) {
		var $bool55,$eq20,$eq21,$bool56,$eq19,$eq22,prevCurrentEvent;
		if ((($bool55=(($eq19=element)===($eq20=$m['sCaptureElem'])&&$eq19===null?true:
			($eq19===null?false:($eq20===null?false:
				((typeof $eq19=='object'||typeof $eq19=='function')&&typeof $eq19.__cmp__=='function'?$eq19.__cmp__($eq20) === 0:
					((typeof $eq20=='object'||typeof $eq20=='function')&&typeof $eq20.__cmp__=='function'?$eq20.__cmp__($eq19) === 0:
						$eq19==$eq20)))))) === null || $bool55 === false || $bool55 === 0 || $bool55 === '' ?
				false :
				(typeof $bool55=='object'?
					(typeof $bool55.__nonzero__=='function'?
						...
						(typeof $bool55.__len__=='function'?
							...
							true ) ) :
					 true ) )) {
			if ((($bool56=(($eq21=$m['eventGetType'](event))===($eq22='losecapture')&&$eq21===null?true:
	...
	$m['insertListItem'] = function(select, item, value, index) {
		var $bool57,option,$bool58,$eq23,$eq24;
		...
		if ((($bool58=(($eq23=index)===($eq24=(typeof ($usub1=1)=='number'?
			-$usub1:
			$p['op_usub']($usub1)))&&$eq23===null?true:
			($eq23===null?false:($eq24===null?false:
				((typeof $eq23=='object'||typeof $eq23=='function')&&typeof $eq23.__cmp__=='function'?$eq23.__cmp__($eq24) === 0:
					((typeof $eq24=='object'||typeof $eq24=='function')&&typeof $eq24.__cmp__=='function'?$eq24.__cmp__($eq23) === 0:
						$eq23==$eq24)))))) === null || $bool58 === false || $bool58 === 0 || $bool58 === '' ?
				false :
