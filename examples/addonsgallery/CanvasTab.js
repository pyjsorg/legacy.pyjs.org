...
$pyjs.loaded_modules['CanvasTab'] = function (__mod_name__) {
		...
		$method = $pyjs__bind_method2('draw', function() {
			...
			while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
				...
				while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
					j = $iter2_nextval;
					self['setFillStyle']($m['Color']($p['sprintf']('rgb(%d,%d,0)', $p['tuple']([$m['floor']((typeof ($sub1=255)==typeof ($sub2=(typeof ($mul1=42.5)==typeof ($mul2=i) && typeof $mul1=='number'?
						$mul1*$mul2:
						...
						$sub3-$sub4:
						$p['op_sub']($sub3,$sub4)))]))));
					self['fillRect']((typeof ($mul5=j)==typeof ($mul6=25) && typeof $mul5=='number'?
						$mul5*$mul6:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('draw', function() {
			...
			while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
				i = $iter3_nextval;
				self['saveContext']();
				self['setFillStyle']($m['Color']($p['sprintf']('rgb(%d,%d,255)', $p['tuple']([(typeof ($mul9=51)==typeof ($mul10=i) && typeof $mul9=='number'?
					$mul9*$mul10:
				...
				while (typeof ($iter4_nextval=($iter4_type?($iter4_type > 0?$iter4_iter.next(true,false):$p['wrapped_next']($iter4_iter)):$iter4_array[$iter4_idx++])) != 'undefined') {
					j = $iter4_nextval;
					self['rotate']((typeof ($div1=(typeof ($mul15=pi)==typeof ($mul16=2) && typeof $mul15=='number'?
						$mul15*$mul16:
						...
						$p['op_div']($div1,$div2)));
					self['beginPath']();
					self['arc'](0, (typeof ($mul19=i)==typeof ($mul20=12.5) && typeof $mul19=='number'?
						$mul19*$mul20:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onImagesLoaded', function(imagesHandles) {
			...
			var $2,$1;
			self.img = (typeof ($1=imagesHandles).__array != 'undefined'?
		...
		$method = $pyjs__bind_method2('draw', function() {
			...
			while (typeof ($iter5_nextval=($iter5_type?($iter5_type > 0?$iter5_iter.next(true,false):$p['wrapped_next']($iter5_iter)):$iter5_array[$iter5_idx++])) != 'undefined') {
				...
				while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,false):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
					...
					self['saveContext']();
					self['translate']((typeof ($add3=50)==typeof ($add4=(typeof ($mul23=j)==typeof ($mul24=100) && typeof $mul23=='number'?
						$mul23*$mul24:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('drawSpirograph', function(R, r, O) {
			...
			var $mul44,$div17,$mul40,$mul35,$mul41,$mul45,$mul46,$mul42,$add27,y1,y2,$add28,$sub13,$div18,$mul49,$add21,$add20,$add22,$div10,$div11,$div12,$add19,$div13,$sub9,$sub8,$add26,$eq3,$add24,pi,$sub7,$sub11,$add25,$add15,$eq1,$mul43,$eq2,$and1,$and2,$sub10,$mul47,$sub14,$bool2,$bool3,$add16,$bool1,$eq4,x2,$mul48,$sub12,x1,$add18,$div7,$cmp1,$cmp2,i,$div16,$mul50,$div8,$div9,$div14,$mul39,$mul38,$div15,$add17,$mul34,$mul37,$mul36,$mul31,$add23,$mul33,$mul32;
			pi = 3.14159265359;
			...
			self['beginPath']();
			self['moveTo'](x1, y1);
			while ((($bool2=((($bool1=$and1=!(($eq1=x2)===($eq2=(typeof ($sub9=R)==typeof ($sub10=O) && (typeof $sub9=='number'||typeof $sub9=='string')?
				$sub9-$sub10:
				$p['op_sub']($sub9,$sub10)))&&$eq1===null?true:
					...
					(typeof $bool1.__nonzero__=='function'?
						...
						(typeof $bool1.__len__=='function'?
							($bool1.__len__()>0 ?
								...
								false) :
							true ) ) :
					 true ) )?!(($eq3=y2)===($eq4=0)&&$eq3===null?true:
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onImagesLoaded', function(imagesHandles) {
			...
			var $3,$8,$6,$7,$4,$5;
			self.sun = (typeof ($3=imagesHandles).__array != 'undefined'?
				((typeof $3.__array[$4=0]) != 'undefined'?$3.__array[$4]:
					$3.__getitem__($4)):
					$3.__getitem__(0));
			self.moon = (typeof ($5=imagesHandles).__array != 'undefined'?
				((typeof $5.__array[$6=1]) != 'undefined'?$5.__array[$6]:
					$5.__getitem__($6)):
					$5.__getitem__(1));
			self.earth = (typeof ($7=imagesHandles).__array != 'undefined'?
	...
	, 1, [null,null,['self'],['t', null]]);
		...
		$method = $pyjs__bind_method2('getTimeSeconds', function() {
			...
			var $mod1,$mod2;
			return (typeof ($mod1=$m['time']['time']())==typeof ($mod2=60) && typeof $mod1=='number'?
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('draw', function() {
			...
			self['rotate']((typeof ($add29=(typeof ($mul55=(typeof ($div19=(typeof ($mul53=2)==typeof ($mul54=pi) && typeof $mul53=='number'?
				$mul53*$mul54:
			...
			self['fillRect'](0, (typeof ($usub4=12)=='number'?
				-$usub4:
				$p['op_usub']($usub4)), 50, 24);
			self['drawImage'](self['earth']['getElement'](), (typeof ($usub5=12)=='number'?
				-$usub5:
				$p['op_usub']($usub5)), (typeof ($usub6=12)=='number'?
				-$usub6:
				$p['op_usub']($usub6)));
			self['saveContext']();
			self['rotate']((typeof ($add31=(typeof ($mul63=(typeof ($div23=(typeof ($mul61=2)==typeof ($mul62=pi) && typeof $mul61=='number'?
				$mul61*$mul62:
			...
			self['restoreContext']();
			self['beginPath']();
			self['arc'](150, 150, 105, 0, (typeof ($mul69=pi)==typeof ($mul70=2) && typeof $mul69=='number'?
				$mul69*$mul70:
