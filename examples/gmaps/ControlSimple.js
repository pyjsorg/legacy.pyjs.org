...
$pyjs.loaded_modules['ControlSimple'] = function (__mod_name__) {
	...
	$m['ControlSimple'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			options = $pyjs_kwargs_call(null, $m['MapOptions'], null, null, [{zoom:4, center:$m['LatLng']((typeof ($usub1=33)=='number'?
				-$usub1:
				$p['op_usub']($usub1)), 151), mapTypeId:$p['getattr']($m['MapTypeId'], 'ROADMAP'), navigationControl:false, scaleControl:true}]);
