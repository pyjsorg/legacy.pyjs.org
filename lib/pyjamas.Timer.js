...
$pyjs.loaded_modules['pyjamas.Timer'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[196] = 'pyjamas.Timer.py, line 196:\n    def __setTimeout(self, delayMillis):';
		$m.__track_lines__[182] = 'pyjamas.Timer.py, line 182:\n    self.__tid = self.__setInterval(periodMillis)';
		$m.__track_lines__[199] = 'pyjamas.Timer.py, line 199:\n    def __clearTimeout(self,tid):';
		$m.__track_lines__[200] = "pyjamas.Timer.py, line 200:\n    raise NotImplementedError, 'Timer is not fully implemented for your platform'";
		$m.__track_lines__[177] = 'pyjamas.Timer.py, line 177:\n    if periodMillis <= 0:';
		$m.__track_lines__[202] = 'pyjamas.Timer.py, line 202:\n    def __setInterval(self, periodMillis):';
		$m.__track_lines__[203] = "pyjamas.Timer.py, line 203:\n    raise NotImplementedError, 'Timer is not fully implemented for your platform'";
		$m.__track_lines__[205] = 'pyjamas.Timer.py, line 205:\n    def __clearInterval(self, tid):';
		$m.__track_lines__[206] = "pyjamas.Timer.py, line 206:\n    raise NotImplementedError, 'Timer is not fully implemented for your platform'";
		...
		$m['Timer'] = (function(){
			...
			$cls_definition.__md5__ = '9767d58c7bca7a1c67db76b05fc5baa8';
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('__init__', function(delayMillis, notify) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '9767d58c7bca7a1c67db76b05fc5baa8') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('__setTimeout', function(delayMillis) {
				...
				$pyjs.track={module:'pyjamas.Timer', lineno:196};$pyjs.trackstack.push($pyjs.track);
				$pyjs.track.module='pyjamas.Timer';
				$pyjs.track.lineno=196;
	...
	, 1, [null,null,['self'],['tid']]);
			...
			$method = $pyjs__bind_method2('__setInterval', function(periodMillis) {
				...
				$pyjs.track={module:'pyjamas.Timer', lineno:202};$pyjs.trackstack.push($pyjs.track);
				$pyjs.track.module='pyjamas.Timer';
				$pyjs.track.lineno=202;
