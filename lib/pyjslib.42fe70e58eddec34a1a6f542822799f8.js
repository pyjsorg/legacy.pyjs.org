...
$m['list'].toString = $m['list'].__str__;
	...
	, 1, ['args',null,['self'],['a1']]);
		...
		$method = $pyjs__bind_method2('__cmp__', function(x) {
			...
			var $attr82,$attr83,$attr80,$attr81,$attr84,$attr79,$attr78,$attr77,$attr76,$attr74,$attr73,r,$attr75;
	...
	, 1, [null,null,['self'],['x']]);
		...
		$method = $pyjs__bind_method2('indices', function(length) {
			...
			var $add44,defstart,$and23,$and22,$and21,$and20,$attr86,$attr87,$attr85,$add47,$add46,$attr89,$add43,$add42,$add41,$add40,start,$sub9,$sub8,$sub17,$sub7,$or5,$or4,$sub18,$sub13,$sub12,$sub11,$sub10,stop,$sub16,$sub15,$sub14,step,$attr96,$div2,$div3,$div1,$div4,$attr95,$attr94,defstop,$add39,$attr91,$attr90,$attr93,$attr92,slicelength,$add48,$add45,$attr88;
			step = $constant_int_0;
			...
			if ($p['bool']($m['op_is'](self['start'], null))) {
				...
				if ($p['bool'](($m['cmp'](start, $constant_int_0) == -1))) {
					start = $m['__op_add']($add39=start,$add40=length);
				}
				if ($p['bool'](($m['cmp'](start, $constant_int_0) == -1))) {
					if ($p['bool'](($m['cmp'](step, $constant_int_0) == -1))) {
			...
			if ($p['bool']($m['op_is'](self['stop'], null))) {
				...
				if ($p['bool'](($m['cmp'](stop, $constant_int_0) == -1))) {
					stop = $m['__op_add']($add41=stop,$add42=length);
				}
				if ($p['bool'](($m['cmp'](stop, $constant_int_0) == -1))) {
					if ($p['bool'](($m['cmp'](step, $constant_int_0) == -1))) {
			...
			if ($p['bool'](($p['bool']($or4=($p['bool']($and20=($m['cmp'](step, $constant_int_0) == -1))?((($m['cmp'](stop, start))|1) == 1):$and20))?$or4:($p['bool']($and22=($m['cmp'](step, $constant_int_0) == 1))?((($m['cmp'](start, stop))|1) == 1):$and22)))) {
				...
				slicelength = $m['__op_add']($add45=(typeof ($div1=$m['__op_add']($add43=$m['__op_sub']($sub13=stop,$sub14=start),$add44=$constant_int_1))==typeof ($div2=step) && typeof $div1=='number' && $div2 !== 0?
					$div1/$div2:
					$m['op_div']($div1,$div2)),$add46=$constant_int_1);
			}
			else {
				slicelength = $m['__op_add']($add47=(typeof ($div3=$m['__op_sub']($sub17=$m['__op_sub']($sub15=stop,$sub16=start),$sub18=$constant_int_1))==typeof ($div4=step) && typeof $div3=='number' && $div4 !== 0?
					$div3/$div4:
					$m['op_div']($div3,$div4)),$add48=$constant_int_1);
			}
	...
	, 1, ['args',['kwargs'],['self']]);
		...
		$method = $pyjs__bind_method2('pop', function(k) {
			...
			if ($p['bool'](($m['cmp']($p['len'](d), $constant_int_1) == 1))) {
				throw ($m['TypeError']($p['sprintf']('pop expected at most 2 arguments, got %s', $m['__op_add']($add49=$constant_int_1,$add50=$p['len'](d)))));
			}
			try {
		...
		try {
			while ($p['bool'](true)) {
				...
				while ($p['bool'](($m['cmp'](i, n) == -1))) {
					...
					i = $m['__op_add']($add51=i,$add52=$constant_int_1);
				}
			...
			if ($generator_state[0] == 2) {
				for (;($generator_state[1] > 0 || typeof($p['__wrapped_next']($iter22_nextval).$nextval) != 'undefined');$generator_state[1] = 0) {
					...
					if ($generator_state[1] == 1) {
						...
						nextIndex = $m['__op_add']($add55=nextIndex,$add56=$constant_int_1);
						$generator_state[1]=2;
					}
					if ($generator_state[1] == 2) {
					}
					...
					if ($generator_state[1] == 3) {
						for (;($generator_state[2] > 0)||($p['bool'](true));$generator_state[2] = 0) {
							...
							if ($generator_state[2] == 1) {
								...
								i = $m['__op_add']($add59=i,$add60=$constant_int_1);
								$generator_state[2]=2;
							}
...
r = Math.round(n*x)/n;
				...
				if ($p['bool'](($p['bool']($or8=$m['op_eq'](c, '{'))?$or8:$m['op_eq'](c, '}')))) {
					...
					if ($p['bool']($m['op_eq'](c, '{'))) {
						...
						if ($p['bool']($m['op_eq'](s.__getitem__(i), '{'))) {
							i = $m['__op_add']($add77=i,$add78=$constant_int_1);
							markup_follows = false;
						}
					}
					...
					while ($p['bool'](($m['cmp'](i, end) == -1))) {
						...
						if ($p['bool']($m['op_eq'](c, '{'))) {
							recursive = true;
							nested = $m['__op_add']($add79=nested,$add80=$constant_int_1);
						}
	...
	, 1, [null,null,['self'],['start'],['end']]);
		...
		$method = $pyjs__bind_method2('_get_argument', function(name) {
			...
			while ($p['bool'](($m['cmp'](i, end) == -1))) {
				...
				i = $m['__op_add']($add95=i,$add96=$constant_int_1);
			}
			empty = !$p['bool'](i);
			if ($p['bool'](empty)) {
			...
			if ($p['bool'](empty)) {
				...
				self.auto_numbering = $m['__op_add']($add97=self['auto_numbering'],$add98=$constant_int_1);
			}
	...
	, 1, [null,null,['self'],['w_obj'],['name'],['start'],['end']]);
		...
		$method = $pyjs__bind_method2('formatter_field_name_split', function() {
			...
			while ($p['bool'](($m['cmp'](i, end) == -1))) {
				...
				i = $m['__op_add']($add109=i,$add110=$constant_int_1);
			}
		...
		$method = $pyjs__bind_method2('_render_field', function(start, end, recursive, level) {
			...
			if ($p['bool'](!$m['op_is'](self['parser_list_w'], null))) {
				if ($p['bool']($m['op_eq'](level, $constant_int_1))) {
					...
					self.last_end = $m['__op_add']($add111=end,$add112=$constant_int_1);
				}
				return self['empty'];
			}
	...
	, 1, [null,null,['self'],['c']]);
		...
		$method = $pyjs__bind_method2('_parse_spec', function(default_type, default_align) {
			...
			i = $constant_int_0;
			got_align = true;
			if ($p['bool'](($p['bool']($and32=((($m['cmp']($m['__op_sub']($sub33=length,$sub34=i), $constant_int_2))|1) == 1))?self['_is_alignment'](spec.__getitem__($m['__op_add']($add113=i,$add114=$constant_int_1))):$and32))) {
				self._align = spec.__getitem__($m['__op_add']($add115=i,$add116=$constant_int_1));
				self._fill_char = spec.__getitem__(i);
				i = $m['__op_add']($add117=i,$add118=$constant_int_2);
			}
			...
			if ($p['bool']($m['op_eq']($m['__op_sub']($sub45=length,$sub46=i), $constant_int_1))) {
				...
				i = $m['__op_add']($add131=i,$add132=$constant_int_1);
			}
			self._type = the_type;
	...
	, 1, [null,null,['self'],['n_prefix'],['sign_char'],['to_number'],['n_number'],['n_remainder'],['has_dec'],['digits']]);
		...
		$method = $pyjs__bind_method2('_fill_digits', function(buf, digits, d_state, n_chars, n_zeros, thousands_sep) {
			...
			$iter30_iter = $m['range']($m['__op_sub']($sub65=d_state,$sub66=$constant_int_1), $m['__op_sub']($sub69=$m['__op_sub']($sub67=d_state,$sub68=n_chars),$sub70=$constant_int_1), (typeof ($usub22=$constant_int_1)=='number'?
				-$usub22:
				$m['op_usub']($usub22)));
		...
		$method = $pyjs__bind_method2('_group_digits', function(spec, digits) {
			...
			while ($p['bool'](true)) {
				...
				if ($p['bool'](($m['cmp'](group, $constant_int_0) == 1))) {
					...
					grouping_state = $m['__op_add']($add155=grouping_state,$add156=$constant_int_1);
					previous = group;
				}
				else {
					group = previous;
		...
		$method = $pyjs__bind_method2('_format_int_or_long', function(w_num, kind) {
			...
			if ($p['bool']($m['op_eq'](tp, 'c'))) {
				...
				if ($p['bool']($m['op_eq'](result.__getitem__($constant_int_0), '-'))) {
					sign_char = '-';
					skip_leading = $m['__op_add']($add161=skip_leading,$add162=$constant_int_1);
					to_prefix = $m['__op_add']($add163=to_prefix,$add164=$constant_int_1);
				}
	...
	, 1, [null,null,['self'],['w_num'],['kind']]);
		...
		$method = $pyjs__bind_method2('_int_to_base', function(base, value) {
			...
			value = $p['abs'](value);
			buf = (typeof ($mul7=$p['list'](['\x00']))==typeof ($mul8=$m['__op_add']($add165=(typeof ($mul5=$constant_int_8)==typeof ($mul6=$constant_int_8) && typeof $mul5=='number'?
				$mul5*$mul6:
				$m['op_mul']($mul5,$mul6)),$add166=$constant_int_6)) && typeof $mul7=='number'?
				$mul7*$mul8:
				$m['op_mul']($mul7,$mul8));
			...
			while ($p['bool'](true)) {
				...
				mod = $m['__op_sub']($sub87=value,$sub88=(typeof ($mul9=div)==typeof ($mul10=base) && typeof $mul9=='number'?
					...
					$m['op_mul']($mul9,$mul10)));
				digit = $p['abs'](mod);
				digit = $m['__op_add']($add167=digit,$add168=($p['bool'](($m['cmp'](digit, $constant_int_10) == -1))? ($m['ord']('0')) : ($m['__op_sub']($sub89=$m['ord']('a'),$sub90=$constant_int_10))));
			...
			if ($p['bool']($m['op_eq'](base, $constant_int_2))) {
				...
				buf.__setitem__(i, '#');
				buf.__setitem__($m['__op_sub']($sub99=i,$sub100=$constant_int_1), $m['chr']($m['__op_add']($add169=$m['ord']('0'),$add170=(typeof ($mod5=base)==typeof ($mod6=$constant_int_10) && typeof $mod5=='number'?
					(($mod5=$mod5%$mod6)<0&&$mod6>0?$mod5+$mod6:$mod5):
					$m['op_mod']($mod5,$mod6)))));
				if ($p['bool'](($m['cmp'](base, $constant_int_10) == 1))) {
					buf.__setitem__($m['__op_sub']($sub101=i,$sub102=$constant_int_2), $m['chr']($m['__op_add']($add171=$m['ord']('0'),$add172=(typeof ($floordiv5=base)==typeof ($floordiv6=$constant_int_10) && typeof $floordiv5=='number' && $floordiv6 !== 0?
	...
	, 1, [null,null,['self'],['w_num'],['kind']]);
		...
		$method = $pyjs__bind_method2('_parse_number', function(s, i) {
			...
			while ($p['bool'](($p['bool']($and55=($m['cmp'](i, length) == -1))?(($m['cmp']('0', ($compare5 = s.__getitem__(i))) < 1)&&($m['cmp']($compare5, ($compare6 = '9')) < 1)):$and55))) {
				i = $m['__op_add']($add173=i,$add174=$constant_int_1);
			}
			rest = i;
			dec_point = ($p['bool']($and57=($m['cmp'](i, length) == -1))?$m['op_eq'](s.__getitem__(i), '.'):$and57);
			if ($p['bool'](dec_point)) {
				rest = $m['__op_add']($add175=rest,$add176=$constant_int_1);
			}
	...
	, 1, [null,null,['self'],['w_float']]);
		...
		$method = $pyjs__bind_method2('_format_complex', function(w_complex) {
			...
			self['_calc_padding'](self['empty'], $m['__op_add']($add183=$m['__op_add']($add181=$m['__op_add']($add179=re_spec['n_total'],$add180=im_spec['n_total']),$add182=$constant_int_1),$add184=(typeof ($mul13=add_parens)==typeof ($mul14=$constant_int_2) && typeof $mul13=='number'?
				$mul13*$mul14:
			...
			while ($iter33_test = typeof($p['__wrapped_next']($iter33_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']('eE'.__contains__(c))) {
					if ($p['bool']('+-'.__contains__(s.__getitem__(idx)))) {
						idx = $m['__op_add']($add185=idx,$add186=$constant_int_1);
					}
					s = $m['__op_add']($add187=$p['__getslice'](s, 0, idx),$add188=$m['sprintf']('%02d', $p['int']($p['__getslice'](s, idx, null))));
					break;
				}
				if ($p['bool']('.eE'.__contains__(c))) {
					break;
