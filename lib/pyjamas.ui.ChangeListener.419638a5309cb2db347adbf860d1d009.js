...
$pyjs.loaded_modules['pyjamas.ui.ChangeListener'] = function (__mod_name__) {
	...
	try {
		...
		$m['fireChangeEvent'] = function(listeners, sender, event) {
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool'](!$p['op_eq'](etype, 'change'));
			...
			while (typeof($p['__wrapped_next']($iter1_nextval).$nextval) != 'undefined') {
				...
				return $p['hasattr'](listener, 'onChange');
					...
					return listener['onChange'](sender);
		...
		$m['ChangeHandler'] = (function(){
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('_changeListeners', (function(){try{try{$pyjs.in_try_except += 1;
				return $p['list']([]);
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_8_err){if (!$p['isinstance']($pyjs_dbg_8_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_8_err);}throw $pyjs_dbg_8_err;
}})()) : $p['setattr'](self, '_changeListeners', (function(){try{try{$pyjs.in_try_except += 1;
				return $p['list']([]);
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_8_err){if (!$p['isinstance']($pyjs_dbg_8_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_8_err);}throw $pyjs_dbg_8_err;
}})()); 
				$pyjs.track.lineno=35;
				(function(){try{try{$pyjs.in_try_except += 1;
				return self['sinkEvents']($p['getattr']($m['Event'], 'ONCHANGE'));
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
				...
				if ((function(){try{try{$pyjs.in_try_except += 1;
					...
					(function(){try{try{$pyjs.in_try_except += 1;
					return $m['fireChangeEvent']($p['getattr'](self, '_changeListeners'), self, event);
	...
	, 1, [null,null,['self'],['event']]);
			...
			$method = $pyjs__bind_method2('addChangeListener', function(listener) {
				...
				(function(){try{try{$pyjs.in_try_except += 1;
				return self['_changeListeners']['append'](listener);
	...
	, 1, [null,null,['self'],['listener']]);
			...
			$method = $pyjs__bind_method2('removeChangeListener', function(listener) {
				...
				(function(){try{try{$pyjs.in_try_except += 1;
				return self['_changeListeners']['remove'](listener);
