	...
	return $collcomp1;}();
		...
		$m['frexp'] = function(x) {
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool']($p['op_eq'](x, $constant_int_0));
			...
			return $p['int']((typeof ($div1=(function(){try{try{$pyjs.in_try_except += 1;
		...
		$m['hypot'] = function(x, y) {
			...
			return $m['sqrt']($p['__op_add']($add5=$constant_int_1,$add6=(typeof ($mul7=(typeof ($div11=y)==typeof ($div12=x) && typeof $div11=='number' && $div12 !== 0?
				$div11/$div12:
