	...
	try {
		...
		$m['normpath'] = function(path) {
			...
			while (typeof($p['__wrapped_next']($iter2_nextval).$nextval) != 'undefined') {
				...
				if ((function(){try{try{$pyjs.in_try_except += 1;
					return $p['bool'](($p['bool']($or3=!$p['op_eq'](comp, '..'))?$or3:($p['bool']($or4=($p['bool']($and10=!$p['bool'](initial_slashes))?!$p['bool'](new_comps):$and10))?$or4:($p['bool']($and12=new_comps)?$p['op_eq'](new_comps.__getitem__((typeof ($usub1=$constant_int_1)=='number'?
					-$usub1:
