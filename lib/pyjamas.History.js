...
$pyjs.loaded_modules['pyjamas.History'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[41] = 'pyjamas.History.py, line 41:\n    print "add listener", listener';
		$m.__track_lines__[42] = 'pyjamas.History.py, line 42:\n    historyListeners.append(listener)';
		$m.__track_lines__[45] = 'pyjamas.History.py, line 45:\n    def back():';
		$m.__track_lines__[46] = 'pyjamas.History.py, line 46:\n    wnd().history.back()';
		$m.__track_lines__[49] = 'pyjamas.History.py, line 49:\n    def forward():';
		$m.__track_lines__[50] = 'pyjamas.History.py, line 50:\n    wnd().history.forward()';
		$m.__track_lines__[53] = 'pyjamas.History.py, line 53:\n    def getToken():';
		$m.__track_lines__[54] = 'pyjamas.History.py, line 54:\n    global historyToken';
		$m.__track_lines__[55] = 'pyjamas.History.py, line 55:\n    return historyToken';
		$m.__track_lines__[58] = 'pyjamas.History.py, line 58:\n    def newItem(ht):';
		$m.__track_lines__[59] = 'pyjamas.History.py, line 59:\n    global historyToken';
		$m.__track_lines__[60] = 'pyjamas.History.py, line 60:\n    if historyToken == ht:';
		$m.__track_lines__[61] = 'pyjamas.History.py, line 61:\n    return';
		$m.__track_lines__[62] = 'pyjamas.History.py, line 62:\n    onHistoryChanged(ht)';
		$m.__track_lines__[63] = 'pyjamas.History.py, line 63:\n    return';
		$m.__track_lines__[65] = 'pyjamas.History.py, line 65:\n    JS("""';
		$m.__track_lines__[74] = 'pyjamas.History.py, line 74:\n    def onHistoryChanged(ht):';
		$m.__track_lines__[75] = 'pyjamas.History.py, line 75:\n    fireHistoryChangedImpl(ht)';
		$m.__track_lines__[79] = 'pyjamas.History.py, line 79:\n    def fireHistoryChangedAndCatch():';
		$m.__track_lines__[80] = 'pyjamas.History.py, line 80:\n    pass';
		$m.__track_lines__[83] = 'pyjamas.History.py, line 83:\n    def fireHistoryChangedImpl(ht):';
		$m.__track_lines__[84] = 'pyjamas.History.py, line 84:\n    global historyToken';
		$m.__track_lines__[85] = 'pyjamas.History.py, line 85:\n    if historyToken == ht:';
		$m.__track_lines__[86] = 'pyjamas.History.py, line 86:\n    return';
		$m.__track_lines__[87] = 'pyjamas.History.py, line 87:\n    historyToken = ht';
		$m.__track_lines__[88] = 'pyjamas.History.py, line 88:\n    for listener in historyListeners:';
		$m.__track_lines__[89] = 'pyjamas.History.py, line 89:\n    listener.onHistoryChanged(ht)';
		$m.__track_lines__[92] = 'pyjamas.History.py, line 92:\n    def removeHistoryListener(listener):';
		$m.__track_lines__[93] = 'pyjamas.History.py, line 93:\n    historyListeners.remove(listener)';
		...
		$m.__track_lines__[99] = 'pyjamas.History.py, line 99:\n    def init():';
		$m.__track_lines__[100] = 'pyjamas.History.py, line 100:\n    print "init", get_main_frame(), pyjd.is_desktop';
		$m.__track_lines__[101] = 'pyjamas.History.py, line 101:\n    if get_main_frame() is None:';
		$m.__track_lines__[102] = 'pyjamas.History.py, line 102:\n    if pyjd.is_desktop:';
		$m.__track_lines__[103] = 'pyjamas.History.py, line 103:\n    pyjd.add_setup_callback(init)';
		$m.__track_lines__[105] = 'pyjamas.History.py, line 105:\n    return';
		$m.__track_lines__[107] = 'pyjamas.History.py, line 107:\n    global historyToken';
		$m.__track_lines__[108] = "pyjamas.History.py, line 108:\n    historyToken = ''";
		$m.__track_lines__[109] = 'pyjamas.History.py, line 109:\n    hash = wnd().location.hash';
		$m.__track_lines__[111] = 'pyjamas.History.py, line 111:\n    if hash and len(hash) > 0:';
		$m.__track_lines__[112] = 'pyjamas.History.py, line 112:\n    historyToken = hash[1:]';
		...
		$m['addHistoryListener'] = function(listener) {
			...
			return $p['printFunc'](['add listener', listener], 1);
		...
		$m['getToken'] = function() {
			...
			$pyjs.track={module:'pyjamas.History',lineno:53};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pyjamas.History';
			$pyjs.track.lineno=53;
			$pyjs.track.lineno=54;
			$pyjs.track.lineno=55;
			$pyjs.track.lineno=55;
			var $pyjs__ret = $m['historyToken'];
			$pyjs.trackstack.pop();$pyjs.track=$pyjs.trackstack.pop();$pyjs.trackstack.push($pyjs.track);
			return $pyjs__ret;
		};
		...
		$m['newItem'] = function(ht) {
			...
			(function(){try{try{$pyjs.in_try_except += 1;
			return (typeof onHistoryChanged == "undefined"?$m.onHistoryChanged:onHistoryChanged)(ht);
    ...
    $wnd.location.hash = encodeURI($m['historyToken']).replace('#','%23');
		...
		$m['onHistoryChanged'] = function(ht) {
			...
			(function(){try{try{$pyjs.in_try_except += 1;
			return (typeof fireHistoryChangedImpl == "undefined"?$m.fireHistoryChangedImpl:fireHistoryChangedImpl)(ht);
		...
		$m['fireHistoryChangedImpl'] = function(ht) {
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool']($p['op_eq']($m['historyToken'], ht));
			...
			while (typeof($p['__wrapped_next']($iter1_nextval).$nextval) != 'undefined') {
				...
				(function(){try{try{$pyjs.in_try_except += 1;
				return listener['onHistoryChanged'](ht);
		...
		$m['init'] = function() {
			if ($pyjs.options.arg_count && arguments.length != 0) $pyjs__exception_func_param(arguments.callee.__name__, 0, 0, arguments.length);
			var $and1,$and2,hash;
			$pyjs.track={module:'pyjamas.History',lineno:99};$pyjs.trackstack.push($pyjs.track);
			$pyjs.track.module='pyjamas.History';
			$pyjs.track.lineno=99;
			$pyjs.track.lineno=100;
			(function(){try{try{$pyjs.in_try_except += 1;
			return $p['printFunc'](['init', (function(){try{try{$pyjs.in_try_except += 1;
			return (typeof get_main_frame == "undefined"?$m.get_main_frame:get_main_frame)();
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_13_err){if (!$p['isinstance']($pyjs_dbg_13_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_13_err);}throw $pyjs_dbg_13_err;
}})(), $p['getattr']($m['pyjd'], 'is_desktop')], 1);
			...
			return (typeof get_main_frame == "undefined"?$m.get_main_frame:get_main_frame)();
				...
				if ((function(){try{try{$pyjs.in_try_except += 1;
					...
					(function(){try{try{$pyjs.in_try_except += 1;
					return $m['pyjd']['add_setup_callback']($m['init']);
			...
			if ((function(){try{try{$pyjs.in_try_except += 1;
				return $p['bool'](($p['bool']($and1=hash)?($p['cmp']((function(){try{try{$pyjs.in_try_except += 1;
			return $p['len'](hash);
}finally{$pyjs.in_try_except-=1;}}catch($pyjs_dbg_19_err){if (!$p['isinstance']($pyjs_dbg_19_err, $p['StopIteration'])){$p['_handle_exception']($pyjs_dbg_19_err);}throw $pyjs_dbg_19_err;
}})(), $constant_int_0) == 1):$and1));
