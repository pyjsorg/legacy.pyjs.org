...
$pyjs.loaded_modules['pyjamas.ui.Event'] = function (__mod_name__) {
	...
	try {
		...
		$m['init'] = function() {
			...
			$pyjs.track.lineno=2;
			(function(){try{try{$pyjs.in_try_except += 1;
			return $m['eventbits'].__setitem__($constant_int_262144, (function(){try{try{$pyjs.in_try_except += 1;
			...
			$pyjs.track.lineno=3;
			(function(){try{try{$pyjs.in_try_except += 1;
			return $m['eventbits'].__setitem__($constant_int_524288, (function(){try{try{$pyjs.in_try_except += 1;
			return $p['tuple'](['input', (function(){try{try{$pyjs.in_try_except += 1;
			return $p['list']([]);
